...
def main():
    ...
    SA = SensitivityAnalyzer(parameter_ranges, dependent_parameter_names=None, method='morris', seed=42, N=1000, num_levels=4)
    ...
    output_path = os.path.join(project_root, 'sampling_test', f'morris_N1000_seed42_levels4.pkl')
