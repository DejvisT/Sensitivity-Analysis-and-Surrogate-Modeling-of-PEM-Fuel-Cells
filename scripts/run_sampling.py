...
def main():
    ...
    samples = pd.read_pickle('data/raw/correct_sobol_sampling/nathaly_sobol_from_leftover_n3336_sobol_leftover_n2336_on_22.06.2025.pkl')
    print(samples.shape)
    ...
    output_path = os.path.join(project_root, 'sampling_test', f'results_sobol_nathaly1000.pkl')
